          ...
          <form :model="confForm" class="col">
            ...
            <div class="form-group row">
              ...
              <input type="text" name="location" class="col-sm-8 form-control" v-model="confForm.location"
                     auto-complete="off"  @input="validate('location')">
            ...
            <div class="form-group row ">
              ...
              <div class="col-sm-8">
                <div class="input-group row mb-2">
                  <input type="text" name="topic" class="form-control" placeholder="Topic" v-model="newTopic">
                  <div class="input-group-append">
                    <button class="btn btn-primary rounded-right" @click.prevent="addTopic()"><i class="fa fa-plus"></i></button>
                  </div>
                </div>
                <button v-for="topic in topics" :key="topic" class="btn btn-outline-primary mr-2 my-1 " data-toggle="tooltip"
